...
- **현황** — 12개 지점사업소를 **1·2·3군**으로 분류해 한눈에 표시. 카드별 등기율·추진위 구성·시행사 성향·소장 능력·우호세력 포섭 상태. 카드를 누르면 **지분율 현황표 · 핵심 이슈 · 관리소장/본사 대응방안** 상세.
- **보고** — 관리소장이 **월례 업무보고**를 작성(6개 항목: ①관리단 구성 동정 ②우호 인원 포섭 ③래포 형성 ④추진위 미팅 ⑤시행/시공사 ⑥계획·착안). 보고별 **댓글 스레드**로 본사와 소통.
- **평가** — 본사 주관 **소장 평가**(월1회) 기준: 우호세력 포섭 70% + 하자 중재 30%, 자문단(특별 지원팀) 구성.
